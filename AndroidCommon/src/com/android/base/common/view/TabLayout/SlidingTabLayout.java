package com.android.base.common.view.TabLayout;
...
import com.android.base.common.view.ViewPager.OnPageChangeListener;
import com.android.base.common.view.ViewPager.ViewPagerPro;
...
public class SlidingTabLayout extends HorizontalScrollView implements OnPageChangeListener {
    ...
    private ViewPagerPro mViewPagerPro;
     ...
     * 关联ViewPager
     */
    public void setViewPager(ViewPagerPro vp) {
        if (vp == null || vp.getAdapter() == null) {
            throw new IllegalStateException("ViewPager or ViewPager adapter can not be NULL !");
        }

        this.mViewPagerPro = vp;
        mCurrentTab = 0;
        this.mViewPagerPro.removeOnPageChangeListener(this);
        this.mViewPagerPro.addOnPageChangeListener(this);
     ...
     */
    public void setViewPager(ViewPagerPro vp, String[] titles) {
        if (vp == null || vp.getAdapter() == null) {
            throw new IllegalStateException("ViewPager or ViewPager adapter can not be NULL !");
        }
     ...
     */
    public void setViewPager(ViewPagerPro vp, String[] titles, FragmentActivity fa, ArrayList<Fragment> fragments) {
        if (vp == null) {
        ...
        this.mViewPagerPro = vp;
        this.mViewPagerPro.setAdapter(new InnerPagerAdapter(fa.getSupportFragmentManager(), fragments, titles));
    ...
    public void notifyDataSetChanged() {
        ...
        this.mTabCount = mTitles == null ? mViewPagerPro.getAdapter().getCount() : mTitles.size();
        View tabView;
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.layout_tab, null);
            CharSequence pageTitle = mTitles == null ? mViewPagerPro.getAdapter().getPageTitle(i) : mTitles.get(i);
    ...
    public void addNewTab(String title) {
        ...
        CharSequence pageTitle = mTitles == null ? mViewPagerPro.getAdapter().getPageTitle(mTabCount) : mTitles.get(mTabCount);
    ...
    private void addTab(final int position, String title, View tabView) {
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position != -1) {
                    if (mViewPagerPro.getCurrentItem() != position) {
                        mViewPagerPro.setCurrentItem(position);
                        if (mListener != null) {
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void setCurrentTab(int currentTab) {
        ...
        mViewPagerPro.setCurrentItem(currentTab);
    }
    ...
    public void disImage(int position) {
        if (position >= mTabCount) {
            position = mTabCount - 1;
        }

        View tabView = mTabsContainer.getChildAt(position);
        ImageView imageView = (ImageView) tabView.findViewById(R.id.iv_hint);
    ...
    public void showImage(int position) {
        ...
        lp.leftMargin =
                (int) (textWidth + mTabPadding) - dp2px(5);
        lp.topMargin = mHeight > 0 ? dp2px(5) : 0;
