 ...
 *
 */
public class MaterialProgress extends Drawable implements Animatable {
    ...
    public MaterialProgress(Context context, View parent) {
        mParent = parent;
     ...
     *
     * @param size One of {@link MaterialProgress.LARGE} or
     *            {@link MaterialProgress.DEFAULT}
     */
