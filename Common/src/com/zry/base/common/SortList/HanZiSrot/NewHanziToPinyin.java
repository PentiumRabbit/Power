 ...
 */
public class NewHanziToPinyin extends HanziToPinyin {
    ...
    private static NewHanziToPinyin sInstance;
    ...
    protected NewHanziToPinyin(boolean hasChinaCollator) {
        mHasChinaCollator = hasChinaCollator;
    }

    public static NewHanziToPinyin getInstance() {
        synchronized (NewHanziToPinyin.class) {
            if (sInstance != null) {
                return sInstance;
            }
