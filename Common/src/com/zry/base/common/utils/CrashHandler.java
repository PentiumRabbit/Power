...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	private String saveCrashInfoToFile(Throwable ex) {
		...
		try {
			...
			com.zry.base.common.utils.Logger.e(TAG, "saveCrashInfoToFile", e);
		}
		return null;
	}
	...
	private void collectCrashDeviceInfo(Context ctx) {
		...
		for (Field field : fields) {
			try {
				...
				com.zry.base.common.utils.Logger.e(TAG, "collectCrashDeviceInfo", e);
			}
		}
	}
	...
	private String getDeviceInfo() {
		...
		sb.append(SEP).append(com.zry.base.common.utils.SysInfoUtil.getIMEI(mContext));
		sb.append(SEP).append(com.zry.base.common.utils.SysInfoUtil.getProductId());
		sb.append(SEP).append(com.zry.base.common.utils.SysInfoUtil.getSDKVersion());
		sb.append(SEP).append(com.zry.base.common.utils.SysInfoUtil.getSDKLevel());
		sb.append("\n");
		return sb.toString();
	}
